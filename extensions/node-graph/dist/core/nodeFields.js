...
exports.fieldsForNode = fieldsForNode;
...
function inferFieldType(v) {
    if (typeof v === 'boolean')
        return 'bool';
    if (typeof v === 'number')
        return Number.isInteger(v) ? 'int' : 'number';
    return 'string';
}
/**
...
function fieldsForNode(node) {
    ...
    if ((_a = def === null || def === void 0 ? void 0 : def.fields) === null || _a === void 0 ? void 0 : _a.length)
        return def.fields;
...
//# sourceMappingURL=nodeFields.js.map