...
exports.BUILTIN_NODES = void 0;
exports.createSandboxGraphJSON = createSandboxGraphJSON;
const PortTypeRegistry_1 = require("../core/PortTypeRegistry");
const F = PortTypeRegistry_1.PortTypeRegistry.Float;
const B = PortTypeRegistry_1.PortTypeRegistry.Bool;
const S = PortTypeRegistry_1.PortTypeRegistry.String;
const Flow = PortTypeRegistry_1.PortTypeRegistry.GraphFlow;
exports.BUILTIN_NODES = [
    {
        typeName: 'FlowStart',
        title: 'Flow Start',
        category: 'Flow',
...
function createSandboxGraphJSON() {
    return {
        version: 1,
        graphId: 'sandbox',
        profile: {
