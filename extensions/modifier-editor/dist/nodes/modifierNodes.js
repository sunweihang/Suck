...
exports.BUILTIN_WHITELIST = exports.MODIFIER_NODE_DEFS = exports.MODIFIER_BUILTIN_NODE_DEFS = exports.ENTRANCE_TYPE = exports.ENTRANCE_LIFECYCLE_PORTS = void 0;
exports.modifierNodeTypeNames = modifierNodeTypeNames;
exports.allModifierRegisterNodes = allModifierRegisterNodes;
exports.findModifierNodeDef = findModifierNodeDef;
...
exports.ENTRANCE_TYPE = 'ModifierEntranceBlueprint';
...
exports.MODIFIER_BUILTIN_NODE_DEFS = [
    {
        typeName: 'FloatConst',
        title: '浮点常量',
        category: '数学',
...
exports.BUILTIN_WHITELIST = exports.MODIFIER_BUILTIN_NODE_DEFS.map((d) => d.typeName);
function modifierNodeTypeNames() {
    return exports.MODIFIER_NODE_DEFS.map((d) => d.typeName);
}
function allModifierRegisterNodes() {
    return [...exports.MODIFIER_NODE_DEFS, ...exports.MODIFIER_BUILTIN_NODE_DEFS];
}
function findModifierNodeDef(typeName) {
    return allModifierRegisterNodes().find((d) => d.typeName === typeName);
}
//# sourceMappingURL=modifierNodes.js.map