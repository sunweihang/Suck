...
exports.BUILTIN_WHITELIST = exports.BALLISTIC_NODE_DEFS = exports.BALLISTIC_BUILTIN_NODE_DEFS = exports.ENTRANCE_TYPE = exports.ENTRANCE_LIFECYCLE_PORTS = void 0;
exports.ballisticNodeTypeNames = ballisticNodeTypeNames;
exports.allBallisticRegisterNodes = allBallisticRegisterNodes;
exports.findBallisticNodeDef = findBallisticNodeDef;
...
exports.ENTRANCE_TYPE = 'BallisticEntranceBlueprint';
exports.BALLISTIC_BUILTIN_NODE_DEFS = [
    {
        typeName: 'FloatConst',
        title: '浮点常量',
        category: '数学',
...
function ballisticNodeTypeNames() {
    return exports.BALLISTIC_NODE_DEFS.map((d) => d.typeName);
}
function allBallisticRegisterNodes() {
    return [...exports.BALLISTIC_NODE_DEFS, ...exports.BALLISTIC_BUILTIN_NODE_DEFS];
}
function findBallisticNodeDef(typeName) {
    return (exports.BALLISTIC_NODE_DEFS.find((d) => d.typeName === typeName) ||
        exports.BALLISTIC_BUILTIN_NODE_DEFS.find((d) => d.typeName === typeName));
}
//# sourceMappingURL=ballisticNodes.js.map