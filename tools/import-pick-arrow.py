#!/usr/bin/env python3
"""AI pick-target arrow → transparent 256 PNG + Cocos meta."""
...
SRC = Path(
    "/Users/sunix/.cursor/projects/Users-CreativeCenter-Suck/assets/pick-arrow-studio.png"
)
WORK = ROOT / "tools/ai-item"
OUT = ROOT / "assets/resources/ui/pick-arrow.png"
UUID = "7e22bb20-00f3-4b02-8002-0000000000f3"
SIZE = 256
...
def main() -> None:
    ...
    studio = WORK / "pick-arrow-studio.png"
    shutil.copy2(SRC, studio)
    cache = WORK / "pick-arrow.rmbg.png"
