#!/usr/bin/env python3
"""AI boost icon → transparent 512 PNG + Cocos meta."""
...
SRC = Path(
    "/Users/sunix/.cursor/projects/Users-CreativeCenter-Suck/assets/ic-boost-studio.png"
)
WORK = ROOT / "tools/ai-item"
OUT = ROOT / "assets/resources/ui/ic-boost.png"
UUID = "7e22bb20-007c-4b02-8002-00000000008c"
SIZE = 512
...
def main() -> None:
    ...
    studio = WORK / "ic-boost-studio.png"
    shutil.copy2(SRC, studio)
    cache = WORK / "ic-boost.rmbg.png"
