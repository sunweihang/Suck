#!/usr/bin/env python3
"""AI settings icons → transparent 256 PNG + Cocos meta."""
...
ICONS = [
    ("ic-music-studio.png", "ic-music.png", "7e22bb20-0069-4b02-8002-000000000069"),
    ("ic-sfx-studio.png", "ic-sfx.png", "7e22bb20-006a-4b02-8002-00000000006a"),
    ("ic-haptic-studio.png", "ic-haptic.png", "7e22bb20-0098-4b02-8002-000000000098"),
    ("ic-home-studio.png", "ic-home-row.png", "7e22bb20-0099-4b02-8002-000000000099"),
    ("ic-skip-studio.png", "ic-skip.png", "7e22bb20-009a-4b02-8002-00000000009a"),
]
...
def process(src_name: str, out_name: str, uuid: str) -> None:
    ...
    if cache.exists():
        ...
        try:
            ...
            cut = flood_alpha(raw)
    dest = OUT / out_name
    out = fit_square(apply_alpha(raw, cut), SIZE)
    dest.parent.mkdir(parents=True, exist_ok=True)
    out.save(dest, "PNG")
    write_meta(dest, uuid, SIZE, SIZE)
    print(dest.name, out.size, "bbox", out.getbbox(), "corner_a", out.getpixel((0, 0))[3])


def main() -> None:
    for src_name, out_name, uuid in ICONS:
        process(src_name, out_name, uuid)
