#!/usr/bin/env python3
"""AI 连线 icon → transparent 256 PNG + Cocos meta."""
...
SRC = Path(
    "/Users/sunix/.cursor/projects/Users-CreativeCenter-Suck/assets/ic-link-studio.png"
)
...
def main() -> None:
    ...
    studio = WORK / "ic-link-studio.png"
    shutil.copy2(SRC, studio)
    cache = WORK / "ic-link.rmbg.png"
